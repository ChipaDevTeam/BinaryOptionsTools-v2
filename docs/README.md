...
1. **Generate bindings** (if using custom build):
...
New examples are organized by language:

- **[Python Examples](../examples/python/)** - Async and sync Python examples
- **[Rust Examples](../examples/rust/)** - Direct Rust examples
