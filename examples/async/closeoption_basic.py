#!/usr/bin/env python3
"""
CloseOption Basic Async Example

This example demonstrates how to use the CloseOptionAsync client
...
async def main():
    ...
    ssid = os.environ.get("CLOSEOPTION_SSID", "your_token|your_sid|true|your_public_code|your_hidden_code")
    ...
    async with CloseOptionAsync(ssid) as client:
        ...
        subscription = await client.subscribe_symbol("EURUSD")
