...
class PointStreamIterator:
    def __aiter__(self) -> "PointStreamIterator": ...
    def __anext__(self) -> str: ...
    def __iter__(self) -> "PointStreamIterator": ...
    def __next__(self) -> str: ...

class HistoryStreamIterator:
    def __aiter__(self) -> "HistoryStreamIterator": ...
    def __anext__(self) -> str: ...
    def __iter__(self) -> "HistoryStreamIterator": ...
    def __next__(self) -> str: ...
...
class RawPocketOption:
    ...
    async def cancel_pending_order(self, ticket: str) -> str: ...
    async def cancel_pending_orders(self, tickets: List[str]) -> str: ...
    ...
    async def history_points(self, asset: str, period: int) -> str: ...
    async def history_ohlc(self, asset: str, period: int) -> str: ...
    async def compile_candles(self, asset: str, custom_period: int, lookback_period: int) -> str: ...
    async def subscribe_symbol(self, symbol: str, subfor: bool = True) -> StreamIterator: ...
    async def subscribe_symbol_chunked(self, symbol: str, chunk_size: int, subfor: bool = True) -> StreamIterator: ...
    async def subscribe_symbol_timed(self, symbol: str, time: Any, subfor: bool = True) -> StreamIterator: ...
    async def subscribe_symbol_time_aligned(self, symbol: str, time: Any, subfor: bool = True) -> StreamIterator: ...
    async def subscribe_points(self, symbol: str) -> PointStreamIterator: ...
    async def subscribe_with_history_mode(
        self, symbol: str, period: int, mode: str = "points"
    ) -> HistoryStreamIterator: ...
    async def send_raw(self, message: str) -> None: ...
    async def subscribe_raw(self) -> RawStreamIterator: ...
