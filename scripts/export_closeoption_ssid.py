...
def save_ssid(ssid: str, filepath: Optional[str] = None):
    ...
    # On POSIX: use os.fchmod to set 0o600
    # On Windows: os.fchmod may not be available; rely on per-user directory isolation
    fd = os.open(filepath, os.O_WRONLY | os.O_CREAT | os.O_TRUNC, 0o600)
    try:
        os.fchmod(fd, 0o600)
    except (AttributeError, OSError):
        # os.fchmod not available (Windows) or failed; file created with default per-user ACLs
        pass
